...
export function Header() {
  ...
  return (
    <section id="home" className="relative h-[90vh] min-h-[600px] flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center gap-4 px-4 sm:gap-6">
        <div className="relative">
          <Image
            ...
            priority
          />
           <div className="absolute -bottom-1 -right-1 text-3xl sm:text-4xl animate-wave">
            👋
          </div>
        </div>
        <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-foreground md:text-6xl lg:text-7xl font-headline">
          Hi, I'm Pranav Singh
        </h1>
        <p className="max-w-3xl text-base sm:text-lg text-muted-foreground md:text-xl">
        ...
        <div className="mt-4 flex flex-col sm:flex-row justify-center gap-4 w-full max-w-sm">
          ...
          <Button asChild variant="outline" size="lg" className="w-full">
            <a href="https://drive.google.com/file/d/1kL6UhvJbTCWjKH4Y8w8naO3BkUmChmO3/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
